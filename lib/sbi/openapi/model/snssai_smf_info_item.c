...
{
    ogs_sbi_snssai_smf_info_item_t *snssai_smf_info_item_local_var = ogs_sbi_malloc(sizeof(ogs_sbi_snssai_smf_info_item_t));
...
void ogs_sbi_snssai_smf_info_item_free(ogs_sbi_snssai_smf_info_item_t *snssai_smf_info_item)
{
    ...
    ogs_sbi_list_for_each(snssai_smf_info_item->dnn_smf_info_list, node) {
...
cJSON *ogs_sbi_snssai_smf_info_item_convertToJSON(ogs_sbi_snssai_smf_info_item_t *snssai_smf_info_item)
{
    ...
    if (!snssai_smf_info_item->s_nssai) {
        ogs_error("ogs_sbi_snssai_smf_info_item_convertToJSON() failed [s_nssai]");
        goto end;
    }
    ...
    if (!snssai_smf_info_item->dnn_smf_info_list) {
        ogs_error("ogs_sbi_snssai_smf_info_item_convertToJSON() failed [dnn_smf_info_list]");
        goto end;
    }
    ...
    if (snssai_smf_info_item->dnn_smf_info_list) {
        ogs_sbi_list_for_each(snssai_smf_info_item->dnn_smf_info_list, dnn_smf_info_list_node) {
...
ogs_sbi_snssai_smf_info_item_t *ogs_sbi_snssai_smf_info_item_parseFromJSON(cJSON *snssai_smf_info_itemJSON)
{
    ...
    if (!s_nssai) {
        ogs_error("ogs_sbi_snssai_smf_info_item_parseFromJSON() failed [s_nssai]");
        goto end;
    }
    ...
    if (!dnn_smf_info_list) {
        ogs_error("ogs_sbi_snssai_smf_info_item_parseFromJSON() failed [dnn_smf_info_list]");
        goto end;
    }
