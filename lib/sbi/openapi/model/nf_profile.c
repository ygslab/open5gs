...
{
    ogs_sbi_nf_profile_t *nf_profile_local_var = ogs_sbi_malloc(sizeof(ogs_sbi_nf_profile_t));
...
void ogs_sbi_nf_profile_free(ogs_sbi_nf_profile_t *nf_profile)
{
    ...
    ogs_sbi_list_for_each(nf_profile->nf_services, node) {
        ogs_sbi_nf_service_free(node->data);
    }
    ogs_sbi_list_free(nf_profile->nf_services);
    ogs_sbi_list_for_each(nf_profile->default_notification_subscriptions, node) {
...
cJSON *ogs_sbi_nf_profile_convertToJSON(ogs_sbi_nf_profile_t *nf_profile)
{
    ...
    if (!nf_profile->nf_instance_id) {
        ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [nf_instance_id]");
        goto end;
    }
    ...
    if (nf_profile->nf_instance_name) {
        if (cJSON_AddStringToObject(item, "nfInstanceName", nf_profile->nf_instance_name) == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [nf_instance_name]");
            goto end;
        }
    }

    if (!nf_profile->nf_type) {
        ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [nf_type]");
        goto end;
    }
    ...
    if (!nf_profile->nf_status) {
        ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [nf_status]");
        goto end;
    }
    ...
    if (nf_profile->heart_beat_timer) {
        if (cJSON_AddNumberToObject(item, "heartBeatTimer", nf_profile->heart_beat_timer) == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [heart_beat_timer]");
            goto end;
        }
    }
    ...
    if (nf_profile->plmn_list) {
        ...
        if (plmn_list == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [plmn_list]");
            goto end;
        }

        ogs_sbi_lnode_t *plmn_list_node;
        if (nf_profile->plmn_list) {
            ogs_sbi_list_for_each(nf_profile->plmn_list, plmn_list_node) {
    ...
    if (nf_profile->s_nssais) {
        ...
        if (s_nssais == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [s_nssais]");
            goto end;
        }

        ogs_sbi_lnode_t *s_nssais_node;
        if (nf_profile->s_nssais) {
            ogs_sbi_list_for_each(nf_profile->s_nssais, s_nssais_node) {
    ...
    if (nf_profile->per_plmn_snssai_list) {
        ...
        if (per_plmn_snssai_list == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [per_plmn_snssai_list]");
            goto end;
        }

        ogs_sbi_lnode_t *per_plmn_snssai_list_node;
        if (nf_profile->per_plmn_snssai_list) {
            ogs_sbi_list_for_each(nf_profile->per_plmn_snssai_list, per_plmn_snssai_list_node) {
    ...
    if (nf_profile->nsi_list) {
        ...
        if (nsi_list == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [nsi_list]");
            goto end;
        }

        ogs_sbi_lnode_t *nsi_list_node;
        ogs_sbi_list_for_each(nf_profile->nsi_list, nsi_list_node)  {
    ...
    if (nf_profile->fqdn) {
        if (cJSON_AddStringToObject(item, "fqdn", nf_profile->fqdn) == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [fqdn]");
            goto end;
        }
    }
    ...
    if (nf_profile->inter_plmn_fqdn) {
        if (cJSON_AddStringToObject(item, "interPlmnFqdn", nf_profile->inter_plmn_fqdn) == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [inter_plmn_fqdn]");
            goto end;
        }
    }
    ...
    if (nf_profile->ipv4_addresses) {
        ...
        if (ipv4_addresses == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [ipv4_addresses]");
            goto end;
        }

        ogs_sbi_lnode_t *ipv4_addresses_node;
        ogs_sbi_list_for_each(nf_profile->ipv4_addresses, ipv4_addresses_node)  {
    ...
    if (nf_profile->ipv6_addresses) {
        ...
        if (ipv6_addresses == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [ipv6_addresses]");
            goto end;
        }

        ogs_sbi_lnode_t *ipv6_addresses_node;
        ogs_sbi_list_for_each(nf_profile->ipv6_addresses, ipv6_addresses_node)  {
    ...
    if (nf_profile->allowed_plmns) {
        ...
        if (allowed_plmns == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [allowed_plmns]");
            goto end;
        }

        ogs_sbi_lnode_t *allowed_plmns_node;
        if (nf_profile->allowed_plmns) {
            ogs_sbi_list_for_each(nf_profile->allowed_plmns, allowed_plmns_node) {
    ...
    if (nf_profile->allowed_nf_types) {
        ...
        if (allowed_nf_types == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [allowed_nf_types]");
            goto end;
        }
        ogs_sbi_lnode_t *allowed_nf_types_node;
        ogs_sbi_list_for_each(nf_profile->allowed_nf_types, allowed_nf_types_node) {
    ...
    if (nf_profile->allowed_nf_domains) {
        ...
        if (allowed_nf_domains == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [allowed_nf_domains]");
            goto end;
        }

        ogs_sbi_lnode_t *allowed_nf_domains_node;
        ogs_sbi_list_for_each(nf_profile->allowed_nf_domains, allowed_nf_domains_node)  {
    ...
    if (nf_profile->allowed_nssais) {
        ...
        if (allowed_nssais == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [allowed_nssais]");
            goto end;
        }

        ogs_sbi_lnode_t *allowed_nssais_node;
        if (nf_profile->allowed_nssais) {
            ogs_sbi_list_for_each(nf_profile->allowed_nssais, allowed_nssais_node) {
    ...
    if (nf_profile->priority) {
        if (cJSON_AddNumberToObject(item, "priority", nf_profile->priority) == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [priority]");
            goto end;
        }
    }
    ...
    if (nf_profile->capacity) {
        if (cJSON_AddNumberToObject(item, "capacity", nf_profile->capacity) == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [capacity]");
            goto end;
        }
    }
    ...
    if (nf_profile->load) {
        if (cJSON_AddNumberToObject(item, "load", nf_profile->load) == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [load]");
            goto end;
        }
    }
    ...
    if (nf_profile->locality) {
        if (cJSON_AddStringToObject(item, "locality", nf_profile->locality) == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [locality]");
            goto end;
        }
    }
    ...
    if (nf_profile->udr_info) {
        ...
        if (udr_info_local_JSON == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [udr_info]");
            goto end;
        }
    ...
    if (nf_profile->udr_info_ext) {
        ...
        if (udr_info_ext == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [udr_info_ext]");
            goto end;
        }

        ogs_sbi_lnode_t *udr_info_ext_node;
        if (nf_profile->udr_info_ext) {
            ogs_sbi_list_for_each(nf_profile->udr_info_ext, udr_info_ext_node) {
    ...
    if (nf_profile->udm_info) {
        ...
        if (udm_info_local_JSON == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [udm_info]");
            goto end;
        }
    ...
    if (nf_profile->udm_info_ext) {
        ...
        if (udm_info_ext == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [udm_info_ext]");
            goto end;
        }

        ogs_sbi_lnode_t *udm_info_ext_node;
        if (nf_profile->udm_info_ext) {
            ogs_sbi_list_for_each(nf_profile->udm_info_ext, udm_info_ext_node) {
    ...
    if (nf_profile->ausf_info) {
        ...
        if (ausf_info_local_JSON == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [ausf_info]");
            goto end;
        }
    ...
    if (nf_profile->ausf_info_ext) {
        ...
        if (ausf_info_ext == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [ausf_info_ext]");
            goto end;
        }

        ogs_sbi_lnode_t *ausf_info_ext_node;
        if (nf_profile->ausf_info_ext) {
            ogs_sbi_list_for_each(nf_profile->ausf_info_ext, ausf_info_ext_node) {
    ...
    if (nf_profile->amf_info) {
        ...
        if (amf_info_local_JSON == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [amf_info]");
            goto end;
        }
    ...
    if (nf_profile->amf_info_ext) {
        ...
        if (amf_info_ext == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [amf_info_ext]");
            goto end;
        }

        ogs_sbi_lnode_t *amf_info_ext_node;
        if (nf_profile->amf_info_ext) {
            ogs_sbi_list_for_each(nf_profile->amf_info_ext, amf_info_ext_node) {
    ...
    if (nf_profile->smf_info) {
        ...
        if (smf_info_local_JSON == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [smf_info]");
            goto end;
        }
    ...
    if (nf_profile->smf_info_ext) {
        ...
        if (smf_info_ext == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [smf_info_ext]");
            goto end;
        }

        ogs_sbi_lnode_t *smf_info_ext_node;
        if (nf_profile->smf_info_ext) {
            ogs_sbi_list_for_each(nf_profile->smf_info_ext, smf_info_ext_node) {
    ...
    if (nf_profile->upf_info) {
        ...
        if (upf_info_local_JSON == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [upf_info]");
            goto end;
        }
    ...
    if (nf_profile->upf_info_ext) {
        ...
        if (upf_info_ext == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [upf_info_ext]");
            goto end;
        }

        ogs_sbi_lnode_t *upf_info_ext_node;
        if (nf_profile->upf_info_ext) {
            ogs_sbi_list_for_each(nf_profile->upf_info_ext, upf_info_ext_node) {
    ...
    if (nf_profile->pcf_info) {
        ...
        if (pcf_info_local_JSON == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [pcf_info]");
            goto end;
        }
    ...
    if (nf_profile->pcf_info_ext) {
        ...
        if (pcf_info_ext == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [pcf_info_ext]");
            goto end;
        }

        ogs_sbi_lnode_t *pcf_info_ext_node;
        if (nf_profile->pcf_info_ext) {
            ogs_sbi_list_for_each(nf_profile->pcf_info_ext, pcf_info_ext_node) {
    ...
    if (nf_profile->bsf_info) {
        ...
        if (bsf_info_local_JSON == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [bsf_info]");
            goto end;
        }
    ...
    if (nf_profile->bsf_info_ext) {
        ...
        if (bsf_info_ext == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [bsf_info_ext]");
            goto end;
        }

        ogs_sbi_lnode_t *bsf_info_ext_node;
        if (nf_profile->bsf_info_ext) {
            ogs_sbi_list_for_each(nf_profile->bsf_info_ext, bsf_info_ext_node) {
    ...
    if (nf_profile->chf_info) {
        ...
        if (chf_info_local_JSON == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [chf_info]");
            goto end;
        }
    ...
    if (nf_profile->chf_info_ext) {
        ...
        if (chf_info_ext == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [chf_info_ext]");
            goto end;
        }

        ogs_sbi_lnode_t *chf_info_ext_node;
        if (nf_profile->chf_info_ext) {
            ogs_sbi_list_for_each(nf_profile->chf_info_ext, chf_info_ext_node) {
    ...
    if (nf_profile->nrf_info) {
        ...
        if (nrf_info_local_JSON == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [nrf_info]");
            goto end;
        }
    ...
    if (nf_profile->nwdaf_info) {
        ...
        if (nwdaf_info_local_JSON == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [nwdaf_info]");
            goto end;
        }
    ...
    if (nf_profile->custom_info) {
        ...
        if (custom_info_object == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [custom_info]");
            goto end;
        }
    ...
    if (nf_profile->recovery_time) {
        if (cJSON_AddStringToObject(item, "recoveryTime", nf_profile->recovery_time) == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [recovery_time]");
            goto end;
        }
    }
    ...
    if (nf_profile->nf_service_persistence) {
        if (cJSON_AddBoolToObject(item, "nfServicePersistence", nf_profile->nf_service_persistence) == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [nf_service_persistence]");
            goto end;
        }
    }
    ...
    if (nf_profile->nf_services) {
        ...
        if (nf_services == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [nf_services]");
            goto end;
        }

        ogs_sbi_lnode_t *nf_services_node;
        if (nf_profile->nf_services) {
            ogs_sbi_list_for_each(nf_profile->nf_services, nf_services_node) {
    ...
    if (nf_profile->nf_profile_changes_support_ind) {
        if (cJSON_AddBoolToObject(item, "nfProfileChangesSupportInd", nf_profile->nf_profile_changes_support_ind) == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [nf_profile_changes_support_ind]");
            goto end;
        }
    }
    ...
    if (nf_profile->nf_profile_changes_ind) {
        if (cJSON_AddBoolToObject(item, "nfProfileChangesInd", nf_profile->nf_profile_changes_ind) == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [nf_profile_changes_ind]");
            goto end;
        }
    }
    ...
    if (nf_profile->default_notification_subscriptions) {
        ...
        if (default_notification_subscriptions == NULL) {
            ogs_error("ogs_sbi_nf_profile_convertToJSON() failed [default_notification_subscriptions]");
            goto end;
        }

        ogs_sbi_lnode_t *default_notification_subscriptions_node;
        if (nf_profile->default_notification_subscriptions) {
            ogs_sbi_list_for_each(nf_profile->default_notification_subscriptions, default_notification_subscriptions_node) {
...
ogs_sbi_nf_profile_t *ogs_sbi_nf_profile_parseFromJSON(cJSON *nf_profileJSON)
{
    ...
    if (!nf_instance_id) {
        ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [nf_instance_id]");
        goto end;
    }
    ...
    if (nf_instance_name) {
        if (!cJSON_IsString(nf_instance_name)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [nf_instance_name]");
            goto end;
        }
    }
    ...
    if (!nf_type) {
        ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [nf_type]");
        goto end;
    }
    ...
    if (!nf_status) {
        ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [nf_status]");
        goto end;
    }
    ...
    if (heart_beat_timer) {
        if (!cJSON_IsNumber(heart_beat_timer)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [heart_beat_timer]");
            goto end;
        }
    }
    ...
    if (plmn_list) {
        ...
        if (!cJSON_IsArray(plmn_list)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [plmn_list]");
            goto end;
        }
    ...
    if (s_nssais) {
        ...
        if (!cJSON_IsArray(s_nssais)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [s_nssais]");
            goto end;
        }
    ...
    if (per_plmn_snssai_list) {
        ...
        if (!cJSON_IsArray(per_plmn_snssai_list)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [per_plmn_snssai_list]");
            goto end;
        }
    ...
    if (nsi_list) {
        ...
        if (!cJSON_IsArray(nsi_list)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [nsi_list]");
            goto end;
        }
    ...
    if (fqdn) {
        if (!cJSON_IsString(fqdn)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [fqdn]");
            goto end;
        }
    }
    ...
    if (inter_plmn_fqdn) {
        if (!cJSON_IsString(inter_plmn_fqdn)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [inter_plmn_fqdn]");
            goto end;
        }
    }
    ...
    if (ipv4_addresses) {
        ...
        if (!cJSON_IsArray(ipv4_addresses)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [ipv4_addresses]");
            goto end;
        }
    ...
    if (ipv6_addresses) {
        ...
        if (!cJSON_IsArray(ipv6_addresses)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [ipv6_addresses]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(ipv6_addresses_local, ipv6_addresses) {
            ...
            ogs_sbi_list_add(ipv6_addressesList, ogs_strdup(ipv6_addresses_local->valuestring));
        }
    }
    ...
    if (allowed_plmns) {
        ...
        if (!cJSON_IsArray(allowed_plmns)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [allowed_plmns]");
            goto end;
        }
    ...
    if (allowed_nf_types) {
        ...
        if (!cJSON_IsArray(allowed_nf_types)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [allowed_nf_types]");
            goto end;
        }
    ...
    if (allowed_nf_domains) {
        ...
        if (!cJSON_IsArray(allowed_nf_domains)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [allowed_nf_domains]");
            goto end;
        }
    ...
    if (allowed_nssais) {
        ...
        if (!cJSON_IsArray(allowed_nssais)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [allowed_nssais]");
            goto end;
        }
    ...
    if (priority) {
        if (!cJSON_IsNumber(priority)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [priority]");
            goto end;
        }
    }
    ...
    if (capacity) {
        if (!cJSON_IsNumber(capacity)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [capacity]");
            goto end;
        }
    }
    ...
    if (load) {
        if (!cJSON_IsNumber(load)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [load]");
            goto end;
        }
    }
    ...
    if (locality) {
        if (!cJSON_IsString(locality)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [locality]");
            goto end;
        }
    }
    ...
    if (udr_info_ext) {
        ...
        if (!cJSON_IsArray(udr_info_ext)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [udr_info_ext]");
            goto end;
        }
    ...
    if (udm_info_ext) {
        ...
        if (!cJSON_IsArray(udm_info_ext)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [udm_info_ext]");
            goto end;
        }
    ...
    if (ausf_info_ext) {
        ...
        if (!cJSON_IsArray(ausf_info_ext)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [ausf_info_ext]");
            goto end;
        }
    ...
    if (amf_info_ext) {
        ...
        if (!cJSON_IsArray(amf_info_ext)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [amf_info_ext]");
            goto end;
        }
    ...
    if (smf_info_ext) {
        ...
        if (!cJSON_IsArray(smf_info_ext)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [smf_info_ext]");
            goto end;
        }
    ...
    if (upf_info_ext) {
        ...
        if (!cJSON_IsArray(upf_info_ext)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [upf_info_ext]");
            goto end;
        }
    ...
    if (pcf_info_ext) {
        ...
        if (!cJSON_IsArray(pcf_info_ext)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [pcf_info_ext]");
            goto end;
        }
    ...
    if (bsf_info_ext) {
        ...
        if (!cJSON_IsArray(bsf_info_ext)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [bsf_info_ext]");
            goto end;
        }
    ...
    if (chf_info_ext) {
        ...
        if (!cJSON_IsArray(chf_info_ext)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [chf_info_ext]");
            goto end;
        }
    ...
    if (recovery_time) {
        if (!cJSON_IsString(recovery_time)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [recovery_time]");
            goto end;
        }
    }
    ...
    if (nf_service_persistence) {
        if (!cJSON_IsBool(nf_service_persistence)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [nf_service_persistence]");
            goto end;
        }
    }
    ...
    if (nf_services) {
        ...
        if (!cJSON_IsArray(nf_services)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [nf_services]");
            goto end;
        }
    ...
    if (nf_profile_changes_support_ind) {
        if (!cJSON_IsBool(nf_profile_changes_support_ind)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [nf_profile_changes_support_ind]");
            goto end;
        }
    }
    ...
    if (nf_profile_changes_ind) {
        if (!cJSON_IsBool(nf_profile_changes_ind)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [nf_profile_changes_ind]");
            goto end;
        }
    }
    ...
    if (default_notification_subscriptions) {
        ...
        if (!cJSON_IsArray(default_notification_subscriptions)) {
            ogs_error("ogs_sbi_nf_profile_parseFromJSON() failed [default_notification_subscriptions]");
            goto end;
        }
