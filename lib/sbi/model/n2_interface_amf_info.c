...
{
    n2_interface_amf_info_t *n2_interface_amf_info_local_var = ogs_malloc(sizeof(n2_interface_amf_info_t));
...
n2_interface_amf_info_t *n2_interface_amf_info_parseFromJSON(cJSON *n2_interface_amf_infoJSON)
{
    ...
    if (ipv4_endpoint_address) {
        ...
        cJSON_ArrayForEach(ipv4_endpoint_address_local, ipv4_endpoint_address) {
            ...
            list_addElement(ipv4_endpoint_addressList, ogs_strdup(ipv4_endpoint_address_local->valuestring));
        }
    }
