...
typedef struct amf_info_t {
    ...
    list_t *backup_info_amf_failure; //nonprimitive container
    list_t *backup_info_amf_removal; //nonprimitive container
    struct n2_interface_amf_info_t *n2_interface_amf_info; //model
