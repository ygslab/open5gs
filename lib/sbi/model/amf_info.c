...
amf_info_t *amf_info_create(
    ...
    amf_info_t *amf_info_local_var = malloc(sizeof(amf_info_t));
...
void amf_info_free(amf_info_t *amf_info) {
    ...
    free(amf_info->amf_set_id);
    free(amf_info->amf_region_id);
...
cJSON *amf_info_convertToJSON(amf_info_t *amf_info) {
    ...
    // amf_info->backup_info_amf_failure
    ...
    // amf_info->backup_info_amf_removal
...
amf_info_t *amf_info_parseFromJSON(cJSON *amf_infoJSON){
    ...
    n2_interface_amf_info_local_nonprim = n2_interface_amf_info_parseFromJSON(n2_interface_amf_info); //nonprimitive
    }


    amf_info_local_var = amf_info_create (
        strdup(amf_set_id->valuestring),
        strdup(amf_region_id->valuestring),
        guami_listList,
