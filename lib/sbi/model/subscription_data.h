...
typedef struct subscription_data_t {
    char *nf_status_notification_uri; // string
    char *req_nf_instance_id; // string
    char *subscription_id; // string
    char *validity_time; //date time
    list_t *req_notif_events; //nonprimitive container
    struct plmn_id_t *plmn_id; //model
    struct notif_condition_t *notif_condition; //model
    char *req_nf_type; // string
    char *req_nf_fqdn; // string
    list_t *req_snssais; //nonprimitive container
